...
return {
  ...
  init = function()
    vim.api.nvim_create_autocmd('User', {
      ...
      callback = function()
        ...
        Snacks.toggle.diagnostics():map '<leader>td' -- toggle
        Snacks.toggle.treesitter():map '<leader>tt' -- toggle
        Snacks.toggle.inlay_hints():map '<leader>ty' -- toggle
        Snacks.toggle.indent():map '<leader>tn' -- indent -- toggle
        Snacks.toggle.dim():map '<leader>tm' -- dim -- toggle
      end,
    })
  ...
  keys = {
    ...
    snacks_map { sfx = 'lfd', grp = 'picker', fn = 'lsp_definitions', desc = 'Goto Definition' },
    snacks_map { sfx = 'lfD', grp = 'picker', fn = 'lsp_declarations', desc = 'Goto Declaration' },
    snacks_map { sfx = 'lfr', grp = 'picker', fn = 'lsp_references', desc = 'References' },
    snacks_map { sfx = 'lfi', grp = 'picker', fn = 'lsp_implementations', desc = 'Goto Implementation' },
    snacks_map { sfx = 'lft', grp = 'picker', fn = 'lsp_type_definitions', desc = 'Goto Type Definition' },
    snacks_map { sfx = 'lfs', grp = 'picker', fn = 'lsp_symbols', desc = 'LSP Symbols' },
    snacks_map { sfx = 'lfS', grp = 'picker', fn = 'lsp_workspace_symbols', desc = 'LSP Workspace Symbols' },
  },
}
